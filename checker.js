...
async function checkAirdrop(wallet, proxy = null) {
    ...
    while (!isFetched) {
        await axios.get(`https://geteligibleuserrequest-xqbg2swtrq-uc.a.run.app/?address=${wallet.toLowerCase()}`, config).then(async response => {
            stats[wallet].airdrop = response.data.amount.toFixed(2)
